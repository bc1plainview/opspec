 ...
 */
export type SpecTag = 'invariant' | 'pre' | 'requires' | 'post' | 'ensures' | 'state' | 'access' | 'calls' | 'temporal' | 'opnet';
/**
 ...
 */
export type OpnetConstraint = 'selectors-sha256' | 'csv-timelocks' | 'address-two-params' | 'no-approve';
